...
const articles = {
  ...
  artikel3: {
    title: "Kesehatan Mental Di Sekolah: Tantangan Siswa Zaman Sekarang",

    meta: "Topik: ntahlah • 10 menit baca",

    body: `

    <p>Di era modern, pendidikan tidak hanya berfokus pada prestasi akademik. Kesehatan mental siswa juga merupakan aspek penting yang tidak boleh diabaikan. Tekanan dari tugas sekolah, persaingan akademik, hingga pengaruh media sosial membuat banyak pelajar merasa terbebani. Jika tidak ditangani dengan baik, kondisi ini bisa memengaruhi motivasi belajar, hubungan sosial, bahkan perkembangan karakter mereka.</p>
    
    <p>Menurut UNICEF (2021), lebih dari 1 dari 7 remaja di dunia mengalami gangguan mental, termasuk kecemasan dan depresi. Data ini menegaskan bahwa kesehatan mental siswa adalah isu global yang nyata. Di Indonesia, fenomena serupa juga semakin tampak dengan meningkatnya kasus bullying, tekanan ujian, serta minimnya ruang aman untuk berbicara.</p>
    
    <p>Sekolah memiliki peran vital dalam menjaga kesejahteraan mental siswa. Lingkungan belajar yang mendukung, guru yang peka terhadap kondisi emosional, serta layanan konseling bisa menjadi solusi. Guru dapat menciptakan kelas yang suportif dengan memberi apresiasi, mendorong kolaborasi, dan tidak hanya menekankan hasil akhir. Sementara itu, dukungan positif dari teman sebaya juga sangat berpengaruh.</p>
    
    <p>Selain itu, peran orang tua juga tidak kalah penting. Memahami bahwa kesehatan mental sama berharganya dengan prestasi akademik, memberikan dukungan emosional, serta menjaga komunikasi terbuka dapat membantu anak lebih kuat menghadapi tekanan.</p>
    
    <p>Pendidikan idealnya bukan hanya melahirkan siswa yang unggul secara akademis, tetapi juga tangguh secara emosional. Dengan kerja sama antara guru, orang tua, dan masyarakat, kesehatan mental siswa dapat terjaga sehingga mereka tumbuh menjadi generasi yang tidak hanya cerdas, tetapi juga bahagia dan seimbang.</p>
